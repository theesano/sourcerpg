...
// Client damage rules
	...
	virtual void RadiusDamage_EX(const CTakeDamageInfo &info, const Vector &vecSrc, float flRadius, int iClassIgnore, CBaseEntity *pEntityIgnore, bool bShouldIgnoreDmgFallout);
