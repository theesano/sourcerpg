...
void ActivityList_RegisterSharedActivities( void )
{
	...
	REGISTER_SHARED_ACTIVITY(ACT_EVADE);
	...
	REGISTER_SHARED_ACTIVITY(ACT_MELEE_ATTACK3);
	REGISTER_SHARED_ACTIVITY(ACT_MELEE_ATTACK4);
	REGISTER_SHARED_ACTIVITY(ACT_MELEE_ATTACK5);
	...
	REGISTER_SHARED_ACTIVITY(ACT_MELEE_SPEVADE);
	REGISTER_SHARED_ACTIVITY(ACT_SKILL_EVILSLASH);
	REGISTER_SHARED_ACTIVITY(ACT_SKILL_FEARTRAP);
	REGISTER_SHARED_ACTIVITY(ACT_MELEE_AIR_SP2);
	...
	REGISTER_SHARED_ACTIVITY(ACT_RUN_FINISHED);
...
//===========================
	...
	REGISTER_SHARED_ACTIVITY(ACT_METROPOLICE_DRAW_PISTOL);
	REGISTER_SHARED_ACTIVITY(ACT_METROPOLICE_DEPLOY_MANHACK);
	REGISTER_SHARED_ACTIVITY(ACT_METROPOLICE_FLINCH_BEHIND);
	
	REGISTER_SHARED_ACTIVITY(ACT_WALK_BATON);
	REGISTER_SHARED_ACTIVITY(ACT_IDLE_ANGRY_BATON);
	REGISTER_SHARED_ACTIVITY(ACT_PUSH_PLAYER);

	REGISTER_SHARED_ACTIVITY(ACT_MELEE_ATTACK_THRUST);
	REGISTER_SHARED_ACTIVITY(ACT_ACTIVATE_BATON);
	REGISTER_SHARED_ACTIVITY(ACT_DEACTIVATE_BATON);
