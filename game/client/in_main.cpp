...
void IN_Slot1Down(const CCommand &args) { KeyDown(&in_slot1, args[1]); }
void IN_Slot1Up(const CCommand &args) { KeyUp(&in_slot1, args[1]); }
void IN_Slot2Down(const CCommand &args) { KeyDown(&in_slot2, args[1]); }
void IN_Slot2Up(const CCommand &args) { KeyUp(&in_slot2, args[1]); }
void IN_Slot3Down(const CCommand &args) { KeyDown(&in_slot3, args[1]); }
void IN_Slot3Up(const CCommand &args) { KeyUp(&in_slot3, args[1]); }
void IN_Slot4Down(const CCommand &args) { KeyDown(&in_slot4, args[1]); }
void IN_Slot4Up(const CCommand &args) { KeyUp(&in_slot4, args[1]); }
void IN_Slot5Down(const CCommand &args) { KeyDown(&in_slot5, args[1]); }
...
int CInput::GetButtonBits( int bResetState )
{
	...
	CalcButtonBits(bits, IN_SLOT2, s_ClearInputState, &in_slot2, bResetState);
	CalcButtonBits(bits, IN_SLOT3, s_ClearInputState, &in_slot3, bResetState);
