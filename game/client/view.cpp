...
void GetPos( const CCommand &args, Vector &vecOrigin, QAngle &angles )
{
...
CON_COMMAND(accely, "move y units ahead")
{
	...
	const char *pCommand1 = "accely";
	if (args.ArgC() == 1 && atoi(args[1]) == 1)
	{
		pCommand1 = "accely_exact";
	}
