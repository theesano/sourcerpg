...
// Purpose: 
//-----------------------------------------------------------------------------
void C_WeaponThrowingSkills::DrawFlicker(void)
{
...
//			color - 
//-----------------------------------------------------------------------------
void DrawHaloOrientedWpnThrow(const Vector& source, float scale, float const *color, float roll)
{
	Vector point, screen;
...
// Input  : &data - 
//-----------------------------------------------------------------------------
void WeaponThrowImpactCallback(const CEffectData &data)
{
	// Quick flash
...
DECLARE_CLIENT_EFFECT("cball_bounce", WeaponThrowImpactCallback);

//-----------------------------------------------------------------------------
// Purpose: 
// Input  : &data - 
//-----------------------------------------------------------------------------
void WeaponThrowExplosionCallback(const CEffectData &data)
{
	Vector normal(0, 0, 1);
...
DECLARE_CLIENT_EFFECT("cball_explode",WeaponThrowExplosionCallback);