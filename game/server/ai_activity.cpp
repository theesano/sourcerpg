...
void CAI_BaseNPC::InitDefaultActivitySR(void) 
{
	...
	ADD_ACTIVITY_TO_SR(ACT_MELEE_ATTACK3);
	ADD_ACTIVITY_TO_SR(ACT_MELEE_ATTACK4);
	ADD_ACTIVITY_TO_SR(ACT_MELEE_ATTACK5);
	...
	ADD_ACTIVITY_TO_SR(ACT_MELEE_SPEVADE);
	ADD_ACTIVITY_TO_SR(ACT_SKILL_EVILSLASH);
	ADD_ACTIVITY_TO_SR(ACT_SKILL_FEARTRAP);
	ADD_ACTIVITY_TO_SR(ACT_MELEE_AIR_SP2);
	...
	ADD_ACTIVITY_TO_SR(ACT_RUN_FINISHED);	
...
//===========================
	...
	ADD_ACTIVITY_TO_SR(ACT_METROPOLICE_DRAW_PISTOL);
	ADD_ACTIVITY_TO_SR(ACT_METROPOLICE_DEPLOY_MANHACK);
	ADD_ACTIVITY_TO_SR(ACT_METROPOLICE_FLINCH_BEHIND);

	ADD_ACTIVITY_TO_SR(ACT_WALK_BATON);
	ADD_ACTIVITY_TO_SR(ACT_IDLE_ANGRY_BATON);
	ADD_ACTIVITY_TO_SR(ACT_PUSH_PLAYER);
	ADD_ACTIVITY_TO_SR(ACT_MELEE_ATTACK_THRUST);
	ADD_ACTIVITY_TO_SR(ACT_ACTIVATE_BATON);
	ADD_ACTIVITY_TO_SR(ACT_DEACTIVATE_BATON);
