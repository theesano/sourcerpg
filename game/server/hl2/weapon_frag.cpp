...
/*void CWeaponFrag::Detonate(void)
{
...
{		
	...
	if (pOwner->m_nButtons & IN_USE)
	{
		...
		UTIL_HudMessageAll(tTextParam, "Activated");
...
//	vForward[0] += 0.1f;
	...
	pFrag->SetTimer(GRENADE_TIMER, GRENADE_TIMER);
