...
//
//ConVar lilyss_metropolice_model("lily_metropolice_model", "models/police.mdl");
//
...
//const float MIN_MIN_PISTOL_REST_INTERVAL = 3.0;
//const float MAX_MIN_PISTOL_REST_INTERVAL = 3.5;
//
//// Range for rest period maximums
//const float MIN_MAX_PISTOL_REST_INTERVAL = 5.0;
//const float MAX_MAX_PISTOL_REST_INTERVAL = 6.0;
//
//// Range for burst minimums
//const int 	MIN_MIN_PISTOL_BURST = 1;
//const int 	MAX_MIN_PISTOL_BURST = 1;
//
//// Range for burst maximums
//const int 	MIN_MAX_PISTOL_BURST = 1;
//const int 	MAX_MAX_PISTOL_BURST = 1;
//
